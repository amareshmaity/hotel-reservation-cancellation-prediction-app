...
class ModelTraining:
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info("Start the Hyperparameter Tuning")
            ...
            raise CustomException("Failed to tune hyperparameter and find out best lgbm model", e)
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Model Training Pipeline successfully ended")
